...
const QMetaObject TextViewer::staticMetaObject = {
    { &quarre::InteractionModule::staticMetaObject, qt_meta_stringdata_TextViewer.data,
      qt_meta_data_TextViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TextViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "org.quarre.fr.phone.plugins.interfaces.moduleinterface"))
        return static_cast< quarre::InteractionModule*>(const_cast< TextViewer*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x0a, 0x00, 'T',  'e',  'x',  't',  'V',  'i', 
    'e',  'w',  'e',  'r',  '1',  0x00, 0x00, 0x00,
...
QT_MOC_EXPORT_PLUGIN(TextViewer, TextViewer)
