...
void ScenarioFollower::voidCurrentInteraction() {
    m_current_interaction = 0;
}

void ScenarioFollower::voidNextInteraction() {
...
quarre::Interaction* ScenarioFollower::getCurrentInteraction() const {
    return m_current_interaction;
}

quarre::Interaction* ScenarioFollower::getNextInteraction() const {
    return m_next_interaction;
}
